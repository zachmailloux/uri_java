...
//Global Components
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource()==create){
			...
			refresh();}//of of if clicked create
		
		if(e.getSource()==item){
			JFrame frame = new JFrame();
			Object[] options = {"Trinity Force",
                    "item2",
                    "item3"};
			int iChoice = JOptionPane.showOptionDialog(frame,
					"Click to add an item:", "Item Menu",JOptionPane.YES_NO_CANCEL_OPTION,JOptionPane.QUESTION_MESSAGE,null,options,options[2]);
			if(iChoice==0){
