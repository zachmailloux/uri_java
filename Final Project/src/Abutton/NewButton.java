 ...
 *The class NewButton was originally intended to be used as my example of inheritance. However, upon adding more complex things 
...
public class NewButton extends Abutton {
	/**
	 ...
	 */
	public NewButton(String someLabel,
				   Color someColor,
				   int someX, int someY,
