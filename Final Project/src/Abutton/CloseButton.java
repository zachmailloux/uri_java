 ...
 *The class CloseButton was originally intended to be used as my example of inheritance. However, upon adding more complex things 
...
public class CloseButton extends Abutton {
	 ...
	 */
	public CloseButton(String someLabel,
				   Color someColor,
				   int someX, int someY,
