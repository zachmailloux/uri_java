 ...
 *The class ResumeButton was originally intended to be used as my example of inheritance. However, upon adding more complex things 
 ...
 */
public class ResumeButton extends Abutton {
	/**
	 ...
	 */
	public ResumeButton(String someLabel,
				   Color someColor,
				   int someX, int someY,
